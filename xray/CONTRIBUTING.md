...
### Setup your Xray Github Repository
Fork [Xray upstream](https://github.com/minio/xray/fork) source repository to your own personal repository. Copy the URL for minio from your personal github repo (you will need it for the `git clone` command below).
```sh
...
$ git remote add upstream https://github.com/minio/xray
$ git fetch upstream
